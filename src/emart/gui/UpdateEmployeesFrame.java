...
public class UpdateEmployeesFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jcbJob.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Admin", "Manager", "Receptionist", "Watchman", "Helper", "Cleaner" }));
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jcbEmpId, jcbJob, txtEmpName, txtSalary});
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        if(jcbEmpId.getSelectedIndex()==0){           
            JOptionPane.showMessageDialog(null, "Please select an ID", "ID not selected!", JOptionPane.INFORMATION_MESSAGE);
            return;            
        } 
        try{
            EmployeePojo e=new EmployeePojo(jcbEmpId.getSelectedItem().toString(), txtEmpName.getText(), jcbJob.getSelectedItem().toString(),Double.parseDouble(txtSalary.getText()));
            if(!EmployeeDao.updateEmp(e)){
                JOptionPane.showMessageDialog(null, "Could not update employee!", "UNSUCCESSFUL!", JOptionPane.INFORMATION_MESSAGE);
                return;
            }
            JOptionPane.showMessageDialog(null, "Employee was updated!", "SUCCESSFUL!", JOptionPane.INFORMATION_MESSAGE);
            clear();
        }
