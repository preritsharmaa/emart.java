...
public class UpdateReceptionistFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel3Layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jcbReceptionistId, pfdPassword, txtRePassword, txtReceptionistName});
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if(validateInput()==0){
            JOptionPane.showMessageDialog(null, "Fill passwords");
            return;
        }
        else if(validateInput()==-1){
            JOptionPane.showMessageDialog(null, "Password should be of atleast 4 characters");
            return;
        }
        if(!checkPassword()){
        ...
        try{
            if(!ReceptionistDao.updateReceptionist(jcbReceptionistId.getSelectedItem().toString(), String.valueOf(pfdPassword.getPassword()))){
                JOptionPane.showMessageDialog(null, "Could not update receptionist");
                clear();
                return;            
            }
    ...
    private void loadReceptionistId() {
        try{
            receptionist=ReceptionistDao.getRegisteredReceptionist();
            if(receptionist.isEmpty()){
                JOptionPane.showMessageDialog(null, "No receptionist present");
                jcbReceptionistId.addItem("No Receptionist present");
                btnUpdate.setEnabled(false);
                return;
            }
            btnUpdate.setEnabled(true);
            Set<String> id=receptionist.keySet();
    ...
    private int validateInput() {
        if(pfdPassword.getPassword().toString().isEmpty() || txtRePassword.getText().isEmpty())
            return 0;
        if(pfdPassword.getPassword().length<4)
            return -1;
        return 1;
    }
